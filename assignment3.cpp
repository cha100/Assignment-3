...
int removeInlineComments(TokenList &tokenList) { return 0; }
...
int removeBlockComments(TokenList &tokenList) { return 0;}
...
Token* getAssignmentStatements(TokenList &tokenList) {return 0; }
